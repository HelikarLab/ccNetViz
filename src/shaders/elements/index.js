...
import vsLabelBackgroundShader from './vsLabelBackgroundShader.glsl';
import fsLabelBackgroundShader from './fsLabelBackgroundShader.glsl';
...
const elementShaders = {
  ...
  vsLabelsShader,
  fsLabelTexture,
  vsLabelBackgroundShader,
  fsLabelBackgroundShader,
  fsCurve,
  vsCurve,
  fsCircle: fsCurve,
  vsCircle,
