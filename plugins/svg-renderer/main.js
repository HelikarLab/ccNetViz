...
var svg_renderer = function(svg, options) {
  ...
  this.set = async (n, e, layout, layout_options = {}) => {
    ...
    const svgHeight = options.styles.svg ? options.styles.svg.height : 1000;
    const svgWidth = options.styles.svg ? options.styles.svg.width : 1000;
