                  ...
                  set: function(t, r, n, i) {
                    for (
                      ...
                      if (
                        ...
                        var l = s <= 0.5 ? c.width / 2 : c.width / 3,
                          d = c.height / 3;
                      o.default.vertices(
                        t.relative,
                        n,
          ...
          z = function(t) {
            return {
              set: function(e, r, n, i) {
                ...
                var h = r.x,
                  c = r.y,
                  l = h <= 0.5 ? Math.abs(a[u].dx) : -Math.abs(a[u].dx),
                  d =
                    c <= 0.5
                      ? Math.abs(a[a.length - 1].dy)
                      : -Math.abs(a[a.length - 1].dy);
                o.default.vertices(e.position, n, h, c, h, c, h, c, h, c),
                  o.default.vertices(e.relative, n, 0, 0, l, 0, l, d, 0, d),
                ...
                return (
                  ...
                  y.label &&
                    ...
                    y.label.backgroundColor ||
                      (e = e || tt.labelsOutline.set(c, m.styles, n, t, x, R)),
                    (e = e || tt.labels.set(c, m.styles, n, t, x, R)),
                    y.label.backgroundColor &&
                      (e =
  ...
  function(t, e, r) {
    ...
    var o = (function() {
      function t(e) {
        ...
        var r = (this.size = this.fontSize + 2 * this.buffer);
        (this.canvas = document.createElement('canvas')),
          ...
          (this.middle = Math.round(
            (r / 2) * (navigator.userAgent.indexOf('Gecko/') >= 0 ? 1.2 : 1)
          )),
          (this.gridOuter = new Float64Array(r * r)),
          (this.gridInner = new Float64Array(r * r)),
          (this.f = new Float64Array(r)),
          (this.z = new Float64Array(r + 1)),
          (this.v = new Uint16Array(r)),
