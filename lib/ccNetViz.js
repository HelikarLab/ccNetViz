!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, r) {
            ...
            (this.set = function(e, i, o, s, a, h) {
              ...
              for (var M in ((m = []), a)) {
                ...
                var A = a[M],
                  z = b(T, A);
                _(T, z);
                for (var C = t.maxBufferSize, k = 0; k < A.length; k++) {
                  var R = T.size ? T.size(y, A[k]) : 1,
                    P = c + R * T.numVertices,
                    I = f + R * T.numIndices;
                  P >= C && (E(S), _(T, z), (P = c), (I = f)),
                    T.set(y, A[k], c, f) && (d = !0);
                  var N = A.idx[k];
                  (u._iIs[N] = f),
                    (u._iVs[N] = c),
        ...
        class e extends t {
          ...
          strassen3x3(t) {
            ...
            const r = this.get(0, 0),
              ...
              I = (s + a) * (-p + x),
              N = E + C + n * v,
              L = (r + n + i - o - s - u - c) * g + b + _ + E + A + C + k,
              F = E + M + T + (r + n + i - s - a - h - u) * m + C + R + I,
              B = w + s * (-f + l + v - g - m - p + x) + b + E + C + R + P,
              D = w + b + _ + E + a * y,
              q = C + R + P + I + o * d,
              O = E + M + S + u * (-f + d + v - g - m - p + y) + A + z + C,
              U = A + z + C + k + h * l,
              V = E + M + S + T + c * x;
            return (
              e.set(0, 0, N),
                      ...
                      if (((f = i[o][o] - S), e[o] < 0))
                        ...
                        0 === e[o]
                          ...
                          : ((l = i[o][o + 1]),
                            ...
                            (i[o][w - 1] = x[0]),
                            (i[o][w] = x[1]),
                            Math.abs(l) > Math.abs(C) + Math.abs(T)
                              ? ((i[o + 1][w - 1] =
      ...
      function he(t, e, r, n) {
        var i, o, s, a;
        Ct.getCurveShift(r, n), (i = -n.y), (o = n.x * t.aspect2);
            ...
            se(t, [
              {
                ...
                value: function(t, e) {
                  var r,
                    ...
                    i,
                    o,
                    s = Ct.edgeSource(this.e),
                    a = Ct.edgeTarget(this.e);
                  return (
                    (r = s.x),
                    (n = s.y),
                    (i = a.x),
            ...
            se(t, [
              {
                ...
                value: function(t, e) {
                  var r, n, i;
                  (r = (i = Ct.edgeSource(this.e)).x), (n = i.y);
            ...
            se(t, [
              {
                ...
                value: function(t, e, r) {
                  var n,
                    ...
                    o,
                    s,
                    a = Ct.edgeSource(this.e),
                    h = Ct.edgeTarget(this.e);
      ...
      var ge = { nodes: ue, lines: fe, circles: le, curves: de, labels: ce },
        ...
        Ae = function(
          ...
          var S,
            ...
            L = function(t, e, r, n) {
              var i, o, s, a, h, u, c, f;
              Ct.getCurveShift(n.e, P),
                (s = P.x),
                (a = P.y),
                (c = P.cx),
                (f = P.cy),
                Ct.getCurveShift(r.e, I),
                (i = I.x),
                (o = I.y),
                (h = I.cx),
                (u = I.cy),
          ...
          (this.set = function(t, e, r, n) {
            ...
            if (
              ((this.getCurrentSpatialSearch = function(e) {
                return (
                  void 0 === q &&
                    (q = new me(e, h, c, t, w, o, _, u, E, l, b, C, d, y, x)),
                  q
                );
              }),
              ...
              for (
                ...
                (k = void 0),
                  ...
                  (R =
                    R ||
                    H.nodes.set(i, c.styles, P, k ? t : [], k ? w : {}, A)),
                  (k = t.length && t[0].color),
                  (R =
                    R ||
                    H.nodesColored.set(
                  ...
                  d.label &&
                    (h.clear(),
                    (R =
                      (R = R || H.labelsOutline.set(i, c.styles, I, t, w, z)) ||
                      H.labels.set(i, c.styles, I, t, w, z)),
                    h.bind()),
                  (R = R || H.lines.set(i, c.styles, P, o, _, F.lines)),
                  W.OES_standard_derivatives &&
                    (R =
                      (R = R || H.curves.set(i, c.styles, P, u, E, F.curves)) ||
                      H.circles.set(i, c.styles, P, l, b, F.circles)),
                  g.arrow &&
                    ((R =
                      R ||
                      H.lineArrows.set(i, c.styles, P, o, _, D.lineArrows)),
                    W.OES_standard_derivatives &&
                      (R =
                        (R =
                          R ||
          ...
          if (
            (this.hasEdgeAnimation
              ? H.add(
                  ...
                  new v(
                    ...
                    null,
                    Te.vsLine,
                    Te.fsLineAnimate(g.animateEase),
                    function(t) {
              ...
              : H.add(
                  'lines',
                  new v(i, g, null, Te.vsLine, Te.fsLineBasic, function(t) {
                    var e = t.shader.uniforms;
                    e.exc && i.uniform1f(e.exc, t.curveExc),
                      i.uniform2f(e.screen, t.width, t.height);
            ...
            W.OES_standard_derivatives &&
              (H.add(
                'curves',
                new v(i, g, null, Te.vsCurve, Te.fsCurve, function(t) {
                  var e = t.shader.uniforms;
          ...
          if (
            ...
            for (var rt in et) {
              var nt = et[rt];
              nt.texture && s.get(i, nt.texture, E),
                nt.arrow && nt.arrow.texture && s.get(i, nt.arrow.texture);
            }
          }
        };
      function ze(t, e) {
        ...
        De = (function() {
          function t(e, r) {
            !(function(t, e) {
              ...
              (this.height = Be),
              (this._resetCache = r),
              (this.bin = new Le.a(this.width, this.height)),
              (this.index = {}),
              (this.ids = {}),
              (this.gl = e),
            ...
            },
            {
              ...
              value: function(t) {
                for (
                  ...
                  a.push.apply(a, qe(f).concat(qe(u.slice(i, o + 1)), qe(f)));
                }
        ...
        We = (function() {
          function t(e, r, n) {
            ...
            Ye(this, t),
              ...
              (this._files = r),
              (this._gl = e),
              (this.atlas = new De(this._gl, function() {
                i._cachedGlyphs = {};
              })),
              (this._glyphs = {}),
              (this._rects = {}),
              (this._cachedGlyphs = {}),
              (this.spriteGenerator = new je());
          }
          var e, r, n;
          return (
            (e = t),
      ...
      var er = (function() {
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this._toAddEdges.forEach(function(e) {
                    ...
                    t._checkUniqId(e), tr(t._actualTempEdges, e);
                  });
                },
              },
              {
        ...
        rr = document.createElement('canvas');
      function nr(t) {
      ...
      var ar = function(t, e) {
        ...
        var A,
          z,
          C = e.getEdgesCnt || this.cntShownEdges,
        ...
        var I = void 0;
        function N() {
          return I || (I = new er(M, P, x, A, z, or)), I;
        }
        (this.set = function(t, n, o) {
          var s =
            arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
          if (R()) return r;
          (z = n || []), (A = t || []).forEach(or), z.forEach(or);
          var a = [];
          return (
