  ...
  return (function(t) {
        ...
        return (
          (t.prototype.pack = function(t, e) {
            ...
            if (this.shelves.length > 0) {
              for (var h = 0, u = 0, f = 0; f < this.shelves.length; f++) {
                var c = this.shelves[f];
                (u += c.h), (h = Math.max(c.w - c.free, h));
              }
              this.resize(h, u);
            }
            return s;
          ...
          (t.prototype.packOne = function(t, r, n) {
            ...
            return -1 !== l.freebin
              ...
              : this.autoResize
              ? ((h = u = this.h),
                ((f = c = this.w) <= h || t > f) && (c = 2 * Math.max(t, f)),
                (h < f || r > h) && (u = 2 * Math.max(r, h)),
                this.resize(c, u),
                this.packOne(t, r, n))
              : null;
          }),
    ...
    function(t, e, r) {
          ...
          function t(e, r, n, i, o, s, a) {
            ...
            var f,
              ...
              E = function(e, r, n, i, o) {
                ...
                for (var h = [void 0, r, n], f = 0; f < i; f++) h.push(0);
                for (var c in e)
                  'indices' === c
                    ? t.indices.apply(u, s)
                    : ((h[0] = e[c]), t.vertices.apply(u, h));
              };
            (this.set = function(e, i, o, s, a, h) {
              ...
              for (var M in ((m = []), a)) {
                ...
                var A = a[M],
                  C = b(T, A);
                _(T, C);
                for (var z = t.maxBufferSize, k = 0; k < A.length; k++) {
                  var R = T.size ? T.size(y, A[k]) : 1,
                    P = f + R * T.numVertices,
                    I = c + R * T.numIndices;
                  P >= z && (E(S), _(T, C), (P = f), (I = c)),
                    T.set(y, A[k], f, c) && (d = !0);
                  var N = A.idx[k];
                  (u._iIs[N] = c),
                    (u._iVs[N] = f),
        ...
        m = function(t, e) {
          ...
          this.apply = function() {
            ...
            for (var u = 0; u < e.length; u++) {
              var d = e[u];
              d.source.weight++, d.target.weight++, (f[u] = 15), (c[u] = 1);
            }
            for (r = 0.1; !v(); );
            return !0;
          };
      ...
      var F = function(t) {
        ...
        for (var u = (h - s) / (i - n), f = 0; f < t.length; f++)
          e[f] = (t[f] - n) * u + s;
        return e;
      };
      class B {
        constructor(t) {
          var e,
            ...
            h,
            u,
            f = (t = ht.checkMatrix(t)).clone(),
            c = f.rows,
            l = f.columns,
            d = new Array(c),
            v = 1;
          for (e = 0; e < c; e++) d[e] = e;
          for (h = new Array(c), r = 0; r < l; r++) {
            for (e = 0; e < c; e++) h[e] = f.get(e, r);
            for (e = 0; e < c; e++) {
            ...
            if (i !== r) {
              for (n = 0; n < l; n++)
                (s = f.get(i, n)), f.set(i, n, f.get(r, n)), f.set(r, n, s);
              (a = d[i]), (d[i] = d[r]), (d[r] = a), (v = -v);
            }
            if (r < c && 0 !== f.get(r, r))
              for (e = r + 1; e < c; e++)
                f.set(e, r, f.get(e, r) / f.get(r, r));
          }
          (this.LU = f), (this.pivotVector = d), (this.pivotSign = v);
        }
        isSingular() {
      ...
      class O {
        constructor(t, e = {}) {
          ...
          if (r < n)
            if (s) {
              (r = (a = t.transpose()).rows), (n = a.columns), (f = !0);
              var c = h;
              (h = u), (u = c);
            } else
              (a = t.clone()),
          ...
          for (let t = 0; t < _; t++) {
            if (t < w) {
              v[t] = 0;
              for (let e = t; e < r; e++) v[t] = D(v[t], a[e][t]);
              if (0 !== v[t]) {
                a[t][t] < 0 && (v[t] = -v[t]);
            ...
            if (t < b) {
              p[t] = 0;
              for (let e = t + 1; e < n; e++) p[t] = D(p[t], p[e]);
              if (0 !== p[t]) {
                p[t + 1] < 0 && (p[t] = 0 - p[t]);
        ...
        class e extends t {
          ...
          strassen3x3(t) {
            ...
            const r = this.get(0, 0),
              ...
              I = (s + a) * (-p + x),
              N = E + z + n * v,
              L = (r + n + i - o - s - u - f) * g + b + _ + E + A + z + k,
              F = E + M + T + (r + n + i - s - a - h - u) * m + z + R + I,
              B = w + s * (-c + l + v - g - m - p + x) + b + E + z + R + P,
              D = w + b + _ + E + a * y,
              q = z + R + P + I + o * d,
              O = E + M + S + u * (-c + d + v - g - m - p + y) + A + C + z,
              U = A + C + z + k + h * l,
              j = E + M + S + T + f * x;
            return (
              e.set(0, 0, N),
          ...
          mmulStrassen(t) {
            ...
            return (function t(r, n, i, o) {
              ...
              var s = parseInt(r.rows / 2, 10),
                ...
                f = n.subMatrix(0, s - 1, 0, h - 1),
                c = r.subMatrix(0, s - 1, h, r.columns - 1),
                ...
                p = t(e.add(u, g), e.add(f, m), s, h),
                y = t(e.add(d, g), f, s, h),
                x = t(u, e.sub(l, m), s, h),
                w = t(g, e.sub(v, f), s, h),
                b = t(e.add(u, c), m, s, h),
                _ = t(e.sub(d, u), e.add(f, l), s, h),
                E = t(e.sub(c, g), e.add(v, m), s, h),
                M = e.add(p, w);
              M.sub(b), M.add(E);
              var S = e.add(x, b),
                T = e.add(y, w),
                A = e.sub(p, y);
              A.add(x), A.add(_);
              var C = e.zeros(2 * M.rows, 2 * M.columns);
              return (C = (C = (C = (C = C.setSubMatrix(M, 0, 0)).setSubMatrix(
                S,
                M.rows,
                0
          ...
          scaleRows(t, e) {
            ...
            for (
              ...
              var i = F(this.getRow(n), { min: t, max: e });
              r.setRow(n, i);
            }
            return r;
          }
          scaleColumns(t, e) {
            ...
            for (
              ...
              var i = F(this.getColumn(n), { min: t, max: e });
              r.setColumn(n, i);
            }
            return r;
          }
        ...
        constructor(t, e = {}) {
          ...
          if (!!r || t.isSymmetric()) {
            ...
            !(function(t, e, r, n) {
              ...
              for (a = t - 1; a > 0; a--) {
                for (c = 0, s = 0, u = 0; u < a; u++) c += Math.abs(r[u]);
                if (0 === c)
                  for (e[a] = r[a - 1], h = 0; h < a; h++)
                    (r[h] = n[a - 1][h]), (n[a][h] = 0), (n[h][a] = 0);
                else {
                  for (u = 0; u < a; u++) (r[u] /= c), (s += r[u] * r[u]);
                  for (
                    i = r[a - 1],
                      o = Math.sqrt(s),
                      i > 0 && (o = -o),
                  ...
                  for (i = 0, h = 0; h < a; h++)
                    (e[h] /= s), (i += e[h] * r[h]);
                  for (f = i / (s + s), h = 0; h < a; h++) e[h] -= f * r[h];
                  for (h = 0; h < a; h++) {
              ...
              (function(t, e, r, n) {
                var i, o, s, a, h, u, f, c, l, d, v, g, m, p, y, x;
                ...
                for (u = 0; u < t; u++) {
                  for (
                    b = Math.max(b, Math.abs(r[u]) + Math.abs(e[u])), f = u;
                    f < t && !(Math.abs(e[f]) <= _ * b);
                ...
                for (s = 0; s < t - 1; s++) {
                  for (h = s, c = r[s], a = s + 1; a < t; a++)
                    r[a] < c && ((h = a), (c = r[a]));
                  if (h !== s)
                    for (r[h] = r[s], r[s] = c, a = 0; a < t; a++)
            ...
            !(function(t, e, r, n) {
              var i,
                ...
                c = t - 1;
              for (u = 1; u <= c - 1; u++) {
                for (f = 0, a = u; a <= c; a++) f += Math.abs(e[a][u - 1]);
                if (0 !== f) {
                  for (s = 0, a = c; a >= u; a--)
                    (r[a] = e[a][u - 1] / f), (s += r[a] * r[a]);
                  for (
                    o = Math.sqrt(s),
                      r[u] > 0 && (o = -o),
                      s -= r[u] * o,
                    ...
                    for (i = 0, a = c; a >= u; a--) i += r[a] * e[a][h];
                    for (i /= s, a = u; a <= c; a++) e[a][h] -= i * r[a];
                  }
                  for (a = 0; a <= c; a++) {
                    for (i = 0, h = c; h >= u; h--) i += r[h] * e[a][h];
                    for (i /= s, h = u; h <= c; h++) e[a][h] -= i * r[h];
                  }
                  (r[u] = f * r[u]), (e[u][u - 1] = f * o);
                }
              }
              for (a = 0; a < t; a++)
              ...
              for (u = c - 1; u >= 1; u--)
                if (0 !== e[u][u - 1]) {
                  for (a = u + 1; a <= c; a++) r[a] = e[a][u - 1];
                  for (h = u; h <= c; h++) {
                    for (o = 0, a = u; a <= c; a++) o += r[a] * n[a][h];
                    for (o = o / r[u] / e[u][u - 1], a = u; a <= c; a++)
                      n[a][h] += o * r[a];
                  }
                }
            })(o, f, c, s),
              (function(t, e, r, n, i) {
                ...
                for (; w >= 0; ) {
                  for (
                    ...
                    h > 0 &&
                    (0 ===
                      (C = Math.abs(i[h - 1][h - 1]) + Math.abs(i[h][h])) &&
                      (C = M),
                    !(Math.abs(i[h][h - 1]) < _ * C));
                  ...
                  if (h === w)
                    ...
                    if (
                      ...
                      (C = Math.abs(i[w][w - 1]) + Math.abs(i[w - 1][w - 2])),
                        (l = d = 0.75 * C),
                        (c = -0.4375 * C * C);
                    }
                    if (30 === k && (C = (C = (d - l) / 2) * C + c) > 0) {
                      for (
                        C = Math.sqrt(C),
                          d < l && (C = -C),
                          C = l - c / ((d - l) / 2 + C),
                    ...
                    for (
                      ...
                      ((z = i[u][u]),
                      (S =
                        ((A = l - z) * (C = d - z) - c) / i[u + 1][u] +
                        i[u][u + 1]),
                      (T = i[u + 1][u + 1] - z - A - C),
                      (A = i[u + 2][u + 1]),
                      (C = Math.abs(S) + Math.abs(T) + Math.abs(A)),
                      (S /= C),
                      (T /= C),
                      (A /= C),
                      u !== h) &&
                      ...
                      if (e[o] < 0) (z = c), (C = A);
                        ...
                        0 === e[o]
                          ...
                          : ((l = i[o][o + 1]),
                            ...
                            (i[o][w] = f),
                            (i[o + 1][w] =
                              Math.abs(l) > Math.abs(z)
                                ? (-A - c * f) / l
                                : (-C - d * f) / z)),
                        (f = Math.abs(i[o][w])),
                        _ * f * f > 1)
                      )
                        for (s = o; s <= w; s++) i[s][w] = i[s][w] / f;
                    }
                  else if (T < 0)
                    for (
                      h = w - 1,
                      ...
                      if (((c = i[o][o] - S), e[o] < 0))
                        ...
                        0 === e[o]
                          ...
                          : ((l = i[o][o + 1]),
                            ...
                            (i[o][w - 1] = x[0]),
                            (i[o][w] = x[1]),
                            Math.abs(l) > Math.abs(z) + Math.abs(T)
                              ? ((i[o + 1][w - 1] =
                                  (-v - c * i[o][w - 1] + T * i[o][w]) / l),
                                (i[o + 1][w] =
                                  (-g - c * i[o][w] - T * i[o][w - 1]) / l))
                              : ((x = ft(
                                  -A - d * i[o][w - 1],
                                  -C - d * i[o][w],
                                  z,
          ...
          (r = [
            {
              ...
              value: function() {
                ...
                for (var h = 1; h < o; h++) {
                  for (
                    var u = mt(pt(this._num_elements)), f = 0, c = !1;
                    !c;
              ...
              value: function() {
                ...
                for (o = 0; o < s; )
                  (this._nodes[t.nodes[o + r].index].x = 0.5 + h * (o + 1)),
                    ...
                    ++o;
                var u = [0.85, 0.75],
                  f = [0.4, 1 - this._margin],
                  c = this._nodes.length - e,
                  l = (f[0] - u[0]) / (c - 1),
                  d = (f[1] - u[1]) / (c - 1);
                for (o = 0; o < c; )
              ...
              value: function(t, e) {
                ...
                for (
                  var u = r !== e.maxX ? 1 / (e.maxX - r) : ((r -= 0.5), 1),
                    f = n !== e.maxY ? 1 / (e.maxY - n) : ((n -= 0.5), 1),
                    c = 0;
                  c < i;
                  c++
                ) {
                  var l = t[c];
                  (l.x = u * (l.x - r)), (l.y = f * (l.y - n));
                }
                return e;
              },
            },
      ...
      function Ut(t, e, r, n, i) {
        for (var o, s = [e, r]; s.length; )
          (r = s.pop()) - (e = s.pop()) <= n ||
            (jt(t, e, r, (o = e + Math.ceil((r - e) / n / 2) * n), i),
            s.push(e, o, o, r));
      }
      function jt(t, e, r, n, i) {
        for (var o, s, a, h, u, f, c; r > e; ) {
          for (
            r - e > 600 &&
              ((o = r - e + 1),
              (s = n - e + 1),
            ...
            for (Vt(t, s, c), s++, c--; i(t[s], f) < 0; ) s++;
            for (; i(t[c], f) > 0; ) c--;
          }
          0 === i(t[e], f) ? Vt(t, e, c) : Vt(t, ++c, r),
            c <= n && (e = c + 1),
            n <= c && (r = c - 1);
        }
      }
      ...
      kt.prototype = {
            ...
            for (i = 0, o = e.children.length; i < o; i++)
              (s = e.children[i]),
                Ot(t, (a = e.leaf ? n(s) : s.bbox)) &&
                  (e.leaf ? r.push(s) : qt(t, a) ? this._all(s, r) : h.push(s));
            e = h.pop();
          }
          return r;
        },
        ...
        _build: function(t, e, r, n) {
          ...
          for (Ut(t, e, r, l, this.compareMinX), a = e; a <= r; a += l)
            for (
              Ut(t, a, (u = Math.min(a + l - 1, r)), c, this.compareMinY),
                h = a;
              h <= u;
              h += c
            )
              (f = Math.min(h + c - 1, u)),
                i.children.push(this._build(t, h, f, n - 1));
          return Rt(i, this.toBBox), i;
        },
        _chooseSubtree: function(t, e, r, n) {
          for (
            var i, o, s, a, h, u, f, c, l, d;
            n.push(e), !e.leaf && n.length - 1 !== r;

          ) {
            for (f = c = 1 / 0, i = 0, o = e.children.length; i < o; i++)
              (h = Bt((s = e.children[i]).bbox)),
                (l = t),
                (d = s.bbox),
                (u =
        ...
        _splitRoot: function(t, e) {
          (this.data = {
            ...
            Rt(this.data, this.toBBox);
        },
        _chooseSplitIndex: function(t, e, r) {
          var n, i, o, s, a, h, u, f, c, l, d, v, g, m;
        ...
        _chooseSplitAxis: function(t, e, r) {
          var n = t.leaf ? this.compareMinX : Lt,
            i = t.leaf ? this.compareMinY : Ft;
        ...
        _allDistMargin: function(t, e, r, n) {
          ...
          var i,
            ...
            u = Dt(a) + Dt(h);
          for (i = e; i < r - e; i++)
            (o = t.children[i]), Nt(a, t.leaf ? s(o) : o.bbox), (u += Dt(a));
          for (i = r - e - 1; i >= e; i--)
            (o = t.children[i]), Nt(h, t.leaf ? s(o) : o.bbox), (u += Dt(h));
          return u;
        },
        ...
        for (
          var h = (function(t, e, r, n) {
              ...
              if (Math.abs(s) < 1e-8) o = [Gt(-a)];
                ...
                if (Math.abs(h) < 1e-8) o = [(-1.5 * a) / s, (3 * a) / s];
                  ...
                  var f = 2 * Math.sqrt(-s / 3),
                    c = Math.acos((3 * a) / s / f) / 3,
                    l = (2 * Math.PI) / 3;
                  o = [
                    f * Math.cos(c),
                    f * Math.cos(c - l),
          ...
          if (!(c < 0 || c > 1)) {
            var l = Ht(
              t,
              e,
              r * (1 - c) * (1 - c) + 2 * i * c * (1 - c) + s * c * c,
              n * (1 - c) * (1 - c) + 2 * o * c * (1 - c) + a * c * c
            );
            l < u && (u = l);
          }
        }
      ...
      function ee(t, e, r, n, i, o, s, a, h, u, f) {
        if (s < 0 || s > 1) return !1;
        if (te(f - h, 0)) {
          var c =
            (e * (1 - s) * (1 - s) + 2 * n * s * (1 - s) + o * s * s) / (f - h);
          if (c < 0 || c > 1) return !1;
        }
        return !0;
      }
      function re(t, e, r, n, i, o, s, a, h, u) {
        ...
        if (
          ((c = -r * a + r * u + i * a - i * u + n * s - n * h - o * s + o * h),
          Qt(e, 2 * n - o) &&
            Qt(t, 2 * r - i) &&
            te(c, 0) &&
      ...
      function he(t, e, r, n) {
        var i, o, s, a;
        zt.getCurveShift(r, n), (i = -n.y), (o = n.x * t.aspect2);
        ...
        var f = (2.5 * t.nodeSize * e) / t.width,
          c = (2.5 * t.nodeSize * e) / t.height;
        (s = 0.5 * -n.cy * f),
          (a = 0.5 * n.cx * c),
          (n.x = i + s),
          (n.y = o + a);
            ...
            se(t, [
              {
                ...
                value: function(t, e) {
                  var r,
                    ...
                    i,
                    o,
                    s = zt.edgeSource(this.e),
                    a = zt.edgeTarget(this.e);
                  return (
                    (r = s.x),
                    (n = s.y),
                    (i = a.x),
            ...
            se(t, [
              {
                ...
                value: function(t, e) {
                  var r, n, i;
                  (r = (i = zt.edgeSource(this.e)).x), (n = i.y);
            ...
            se(t, [
              {
                ...
                value: function(t, e, r) {
                  var n,
                    ...
                    o,
                    s,
                    a = zt.edgeSource(this.e),
                    h = zt.edgeTarget(this.e);
      ...
      var ge = { nodes: ue, lines: ce, circles: le, curves: de, labels: fe },
        me = (function() {
          function t(e, r, n, i, o, s, a, h, u, f, c, d, v, g, m) {
            ie(this, t);
            var p = e.size || 1;
              ...
              M = function(t) {
                ...
                (e.size = m(e, s.label || {})),
                  i.forEach(function(t) {
                    ...
                    y.labels.push(b(new fe(t, e, s, h, u, g), f, c++));
                  }),
                  (E[t] = c);
              };
            for (var S in o) M(S);
                ...
                value: function(t, e, r, n, i, o, s, a, h) {
                  ...
                  for (var m = 0; m < v.length; m++) {
                    ...
                    p.intersectsRect(
                      ...
                      this.normalize,
                      this.texts
                    ) && this._tryAddEl(c, p, y, s, a, h);
                  }
                  for (var x in c) c[x].sort(ve);
                  return c;
                },
              },
              {
                ...
                value: function(t, e, r, n, i, o, s, a) {
                  ...
                  var u = n,
                    f = n,
                    c = n * n,
                    l = this.rbushtree.search([e - u, r - f, e + u, r + f]);
                  if (a)
                    for (var d in this.rbushtree_s)
                      l = l.concat(
                        this.rbushtree_s[d].search([e - u, r - f, e + u, r + f])
                      );
                  for (var v = 0; v < l.length; v++) {
                    var g = l[v][4],
                      m = g.dist2(e, r, t, i, this.normalize, this.texts);
                    m > c || this._tryAddEl(h, g, m, o, s, a);
                  }
        ...
        ke = function(t) {
          return ''.concat(pe[t || 'linear']);
        },
        Re = {
          vsLine: Me,
          fsLineAnimate: function(t) {
            return [xe, ke(t), we, be, _e].join('\n');
          },
          fsLineBasic:
            'precision mediump float;\r\nuniform float type;\r\nuniform vec4 color;\r\nvarying vec2 n;\r\nvarying vec2 v_lengthSoFar;\r\nuniform float lineSize;\r\nvoid main(void) {\r\n  float part = abs(fract(length(v_lengthSoFar) * lineSize * 5.0));\r\n\r\n  // line types\r\n  if (type >= 2.5) { // 3.0 dotted\r\n    part = fract(part * 3.0);\r\n    if (part < 0.5)\r\n      discard;\r\n  } else if (type >= 1.5) { // 2.0 - chain dotted\r\n    if (part < 0.15)\r\n      discard;\r\n    if (part > 0.30 && part < 0.45)\r\n      discard;\r\n  } else if (type >= 0.5) { // 1.0 - dashed\r\n    if (part < 0.5)\r\n      discard;\r\n  }\r\n\r\n  gl_FragColor = vec4(color.r, color.g, color.b, color.a - length(n));\r\n}',
          fsColorTexture:
        ...
        Pe = function(
          ...
          var S,
            ...
            L = function(t, e, r, n) {
              var i, o, s, a, h, u, f, c;
              zt.getCurveShift(n.e, P),
                (s = P.x),
                (a = P.y),
                (f = P.cx),
                (c = P.cy),
                zt.getCurveShift(r.e, I),
                (i = I.x),
                (o = I.y),
                (h = I.cx),
                (u = I.cy),
                ...
                t.circleShift &&
                  v.vertices(t.circleShift, e, -u, h, -u, h, -c, f, -c, f);
            },
            F = {
              lines: function(t) {
                return {
                  set: function(t, e, r, n) {
                    var i = zt.edgeSource(e),
                      o = zt.edgeTarget(e),
                      s = i.x - o.x,
                      a = i.y - o.y,
                      h = z(i, o);
            ...
            B = function(t, e, r, n, i, o, s, a) {
              ...
              zt.getCurveShift(n.e, N),
                ...
                (h = n.is_edge ? 0 : 1),
                t.curveShift &&
                  v.vertices(t.curveShift, i, -f, u, -f, u, -f, u, -f, u),
                t.circleShift &&
                  v.vertices(t.circleShift, i, -l, c, -l, c, -l, c, -l, c),
          ...
          (this.set = function(t, e, r, n) {
            ...
            !(function() {
              ...
              var s = { k: '_', kArrow: '_', d: [] },
                ...
                c = { k: 'curves', kArrow: 'curveArrows', d: u };
              if (W.OES_standard_derivatives) {
                ...
                for (
                  var x = 'overlap' === f.bidirectional, w = 0;
                  w < e.length;
                  w++
                ) {
                  var b = void 0,
            ...
            if (
              ((this.getCurrentSpatialSearch = function(e) {
                return (
                  void 0 === q &&
                    (q = new me(e, h, f, t, w, o, _, u, E, l, b, z, d, y, x)),
                  q
                );
              }),
              ...
              for (
                ...
                (k = void 0),
                  ...
                  (k = t.length && !t[0].color),
                  (R =
                    R ||
                    H.nodes.set(i, f.styles, P, k ? t : [], k ? w : {}, A)),
                  (k = t.length && t[0].color),
                  (R =
                    R ||
                    H.nodesColored.set(
                  ...
                  d.label &&
                    (h.clear(),
                    (R =
                      (R = R || H.labelsOutline.set(i, f.styles, I, t, w, C)) ||
                      H.labels.set(i, f.styles, I, t, w, C)),
                    h.bind()),
                  (R = R || H.lines.set(i, f.styles, P, o, _, F.lines)),
                  W.OES_standard_derivatives &&
                    (R =
                      (R = R || H.curves.set(i, f.styles, P, u, E, F.curves)) ||
                      H.circles.set(i, f.styles, P, l, b, F.circles)),
                  g.arrow &&
                    ((R =
                      R ||
                      H.lineArrows.set(i, f.styles, P, o, _, D.lineArrows)),
                    W.OES_standard_derivatives &&
                      (R =
                        (R =
                          R ||
            ...
            (this.updateNode = function(t, r) {
              (M.nodes[r] = t),
                ...
                i &&
                  ...
                  H.labels && H.labels.updateEl(i, t, r, C),
                  H.labelsOutline && H.labelsOutline.updateEl(i, t, r, C));
            }),
            (this.updateEdge = function(t, r) {
              var n = S[r],
                o = T[r];
              (n.d[o] = M.edges[r] = t),
                q && q.update(e, n.k, o, t),
                i &&
                  (H[n.k].updateEl(i, t, o, F[n.k]),
                  g.arrow && H[n.kArrow].updateEl(i, t, o, D[n.kArrow]));
            });
          var O = 0,
            U = 0,
            j = { x: -1, y: -1, title: '' };
          this.removeNodeAtPos = function(t) {
            M.nodes[t] !== j && (O++, M.updateNode(j, t));
          };
          var V = { source: { x: -1, y: -1 }, target: { x: -1, y: -1 } };
          (this.removeEdgeAtPos = function(t) {
            M.edges[t] !== V && (U++, M.updateEdge(V, t));
          }),
          ...
          var W = i ? o.initExtensions(i, 'OES_standard_derivatives') : {},
            ...
            Z = !1;
          if (!i) return f.onLoad && !Z && (Z = !0) && f.onLoad(), this;
          if (
            (this.hasEdgeAnimation
              ? H.add(
                  'lines',
                  new v(
                    ...
                    null,
                    Re.vsLine,
                    Re.fsLineAnimate(g.animateEase),
                    function(t) {
              ...
              : H.add(
                  'lines',
                  new v(i, g, null, Re.vsLine, Re.fsLineBasic, function(t) {
                    var e = t.shader.uniforms;
                    e.exc && i.uniform1f(e.exc, t.curveExc),
                      i.uniform2f(e.screen, t.width, t.height);
            ...
            W.OES_standard_derivatives &&
              (H.add(
                'curves',
                new v(i, g, null, Re.vsCurve, Re.fsCurve, function(t) {
                  var e = t.shader.uniforms;
              ...
              H.add(
                'circles',
                new v(i, g, null, Re.vsCircle, Re.fsCircle, function(t) {
                  var e = t.shader.uniforms;
                  e.exc && i.uniform1f(e.exc, t.curveExc),
                    i.uniform1f(e.width, t.style.width),
                    i.uniform1f(e.type, G(t.style.type)),
            ...
            H.add(
              'lineArrows',
              new v(i, g, 'arrow', Re.vsLineArrow, Re.fsColorTexture, J, K)
            ),
              W.OES_standard_derivatives &&
                (H.add(
                  'curveArrows',
                  new v(i, g, 'arrow', Re.vsCurveArrow, Re.fsColorTexture, J, K)
                ),
                H.add(
                  'circleArrows',
                  new v(
          ...
          H.add(
            'nodes',
            new v(i, d, null, Re.vsNode, Re.fsColorTexture, function(t) {
              var e = p(t),
                r = t.shader.uniforms;
          ...
          var Q = function(t) {
            return function(r) {
              ...
              0 === g && (d = 0),
                ...
                (c = t && a ? new n(a.outlineColor || l) : r.style.color),
                o.uniformColor(i, u.color, c);
            };
          };
          if (
            (d.label &&
            ...
            for (var et in tt) {
              var rt = tt[et];
              rt.texture && s.get(i, rt.texture, E),
                rt.arrow && rt.arrow.texture && s.get(i, rt.arrow.texture);
            }
          }
        };
      function Ie(t, e) {
        ...
        return (
          ...
          (r = [
            ...
            },
            {
              key: 'allLoaded',
              value: function() {
                return f.emptyObject(this._pending);
              },
            },
          ]) && Ie(e.prototype, r),
          n && Ie(e, n),
        ...
        Ve = (function() {
          function t(e, r) {
            !(function(t, e) {
              ...
              (this.height = je),
              (this._resetCache = r),
              (this.bin = new Oe.a(this.width, this.height)),
              (this.index = {}),
              (this.ids = {}),
              (this.gl = e),
              ...
              },
              {
                ...
                value: function(t, e, r, n, i, o) {
                  ...
                  var a = r.width + 2 * n,
                    ...
                    c = h + 2 * u;
                  (f += 4 - (f % 4)), (c += 4 - (c % 4));
                  var l = this.bin.packOne(f, c);
                  if (
                    (l ||
                      (this.resize(), (l = this.bin.packOne(f, c)), o && o()),
                    !l)
                  )
                    return null;
            ...
            },
            {
              ...
              value: function(t) {
                for (
                  ...
                  u = e.slice(f, f + r);
                  var c = Array.apply(null, Array(s)).map(
                    Number.prototype.valueOf,
                    0
                  );
                  a.push.apply(a, Xe(c).concat(Xe(u.slice(i, o + 1)), Xe(c)));
                }
          ...
          (r = [
            ...
            },
            {
              ...
              value: function(t) {
                ...
                if (
                  ...
                  for (
                    var h = a.bitmap, u = a.width, f = [], c = 0;
                    c < h.length;
                    c += u
                  )
                    f.push(Array.from(h.slice(c, c + u)));
                  this.count--;
                }
                return a;
              },
            },
            {
              ...
              value: function(t, e, r, n, i, o, s) {
                ...
                for (var f = 0; f < r; f++) {
                  for (var c = 0; c < e; c++) n[c] = t[f * e + c];
                  this._edt1d(n, i, o, s, e);
                  for (var l = 0; l < e; l++) t[f * e + l] = Math.sqrt(i[l]);
                }
              },
            },
            {
        ...
        Qe = (function() {
          function t(e, r, n) {
            ...
            Ze(this, t),
              ...
              (this._files = r),
              (this._gl = e),
              (this.atlas = new Ve(this._gl, function() {
                i._cachedGlyphs = {};
              })),
              (this._glyphs = {}),
              (this._rects = {}),
              (this._cachedGlyphs = {}),
              (this.spriteGenerator = new We());
          }
          var e, r, n;
          return (
            (e = t),
        ...
        return (
          ...
          (r = [
            ...
            },
            {
              key: 'isSDF',
              value: function(t) {
                return !(!f.isObject(t) || 'sdf' !== t.type);
              },
            },
            {
              key: 'getEngine',
          ...
          (r = [
            {
              ...
              value: function(t, e, r) {
                ...
                return function() {
                  ...
                  return (
                    n || (n = setTimeout(f, e)),
                    c && (h._enable && (a = t.apply(o, i)), (o = i = null)),
                    a
                  );
                };
              },
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this._toAddEdges.forEach(function(e) {
                    ...
                    t._checkUniqId(e), or(t._actualTempEdges, e);
                  });
                },
              },
              {
      ...
      var lr = function(t, e) {
        ...
        var s = (e.styles.background = e.styles.background || {}),
          ...
          h = !1,
          u = !1,
          c = (e.styles.node = e.styles.node || {});
        if (
          ((c.minSize = null != c.minSize ? c.minSize : 6),
          (c.maxSize = c.maxSize || 16),
          (c.color = c.color || 'rgb(255, 255, 255)'),
          c.label)
        ) {
          var d = c.label;
        ...
        var A,
          C,
          z = e.getEdgesCnt || this.cntShownEdges,
        ...
        var I = void 0;
        function N() {
          return I || (I = new sr(M, P, x, A, C, fr)), I;
        }
        (this.set = function(t, n, o) {
          var s =
            arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {};
          if (R()) return r;
          (C = n || []), (A = t || []).forEach(fr), C.forEach(fr);
          var a = [];
          return (
          ...
          (this.removeNode = function(t) {
            return R() ? r : (N().removeNode(t), r);
          }),
          (this.removeEdge = function(t) {
            return R() ? r : (N().removeEdge(t), r);
          }),
          (this.addEdge = function(t) {
            return R() ? r : (N().addEdge(t), r);
          }),
          (this.addNode = function(t) {
            return R() ? r : (N().addNode(t), r);
          }),
          (this.updateNode = function(t) {
            return R() ? r : r.removeNode(t).addNode(t);
          }),
          (this.updateEdge = function(t) {
            return R() ? r : r.removeEdge(t).addEdge(t);
          }),
          (this.applyChanges = function() {
            return R() ? r : (N().applyChanges(), r);
          }),
        ...
        (this.draw = function(e) {
          if ((!e || (!h && u)) && !R()) {
            ...
            (S.transform = o.ortho(
              ...
              (S.curveExc = L(S, void 0, z(), 0.5)),
              (S.style = c),
              (S.nodeSize = F(S)),
              y && y.viewport(0, 0, n, i),
            ...
            v.animateType && 'none' !== v.animateType
              ? (function t() {
                  (S.renderTime = (Date.now() - d) / 1e3),
                    m(),
                    g++,
                    (r.fps = g / S.renderTime),
          ...
          (this.getTextPosition = function(t) {
            if (!R() && y) {
              var r = 0.5 * S.nodeSize,
                n = (2 * (t.y <= 0.5 ? 0 : 1) - 1) * r,
                i = l(e.styles[t.style], c, 'label'),
                o = _.getEngine(i.font);
              o.setFont(i.font);
              var s = o.isSDF ? B(S, i.label || {}) : o.fontSize,
                a = s / o.fontSize;
              return (
                0 === s && (a = 0),
                  ...
                  m &&
                    (s
                      ...
                      : ((p.x = Math.max(
                        ...
                        (p.y = Math.max(
                          0,
                          Math.min(1 - p.size, t.clientY / f - v)
                        )),
                        $(),
                        n.draw()));
                else {
          ...
          Y = function r(n) {
            ...
            if (!r.continuosZoom) {
              ...
              var u = this.getLayerCoords({
                ...
                f = this.findArea(u.x1, u.y1, u.x2, u.y2, !0);
              if (f.nodes.length) {
                var c = f.nodes[0],
        ...
        j(
          ...
          (this.remove = function() {
            if (!R()) {
              ...
              V(t, U), E.disable(), _ && _.remove(), (h = !0);
            }
          });
        var G = {};
        function $() {
          ...
          f.extend(G, p), t && e.onChangeViewport && e.onChangeViewport(p);
        }
        var W = 0;
        (this.image = function() {
          if (!R()) return t.toDataURL();
        }),
          (this.resize = function() {
            R() || ((t.width = t.offsetWidth), (t.height = t.offsetHeight));
          }),
